  ...
  return (
      ...
      <section className="s-connect">
        <div className="row connect-content">
          <div className="column large-half tab-full">
            ...
            <a href="volunteer.html" className="btn btn--primary h-full-width">I'm Interested</a>
          </div>
          <div className="column large-half tab-full">
            ...
            <a href="connect-group.html" className="btn btn--primary h-full-width">Learn More</a>
          </div>
    ...
    ================================================== */}
      <section className="s-series">
        <div className="series-img" style={{backgroundImage: 'url("images/series-2000.jpg")'}} />
        <div className="row row-y-center series-content">
          ...
          <div className="column large-half medium-full">
            <div className="series-content__buttons">
              <a className="btn btn--large h-full-width">Watch the Video</a>
              <a className="btn btn--large h-full-width">Listen To the Message</a>
            </div>
            <div className="series-content__subscribe">
              ...
              <ul className="series-content__subscribe-links">
                ...
                <li className="ss-spotify"><a href="#0">Spotify</a></li>
                <li className="ss-soundcloud"><a href="#0">SoundCloud</a></li>
                <li className="ss-youtube"><a href="#0">Youtube</a></li>
              </ul>
            </div>
          </div> {/* end column */}
        </div> {/* series-content */}
